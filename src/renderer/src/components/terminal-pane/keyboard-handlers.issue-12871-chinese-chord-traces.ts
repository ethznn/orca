...
// rig as the other recordings. Reproduce with
// tests/e2e/terminal-macos-ime-chord-round4-chinese.spec.ts; the e2e half of the same gestures is
// asserted end to end in tests/e2e/terminal-macos-ime-cursor-chord-native.spec.ts.
//
...
//
// What the four cases establish, measured rather than assumed: Chinese behaves like Kotoeri and
...
// behaviours. See scratchpad/ime-traces/round4 for the recordings and the human cross-check.
import type { InAppRecordedCase } from './keyboard-handlers.issue-12871-in-app-chord-traces'

export const CHINESE_TRACE_CASES: InAppRecordedCase[] = [
  {
